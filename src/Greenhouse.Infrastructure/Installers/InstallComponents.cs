...
namespace CluedIn.Crawling.Greenhouse.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IGreenhouseClientFactory>().AsFactory())
                .Register(Component.For<GreenhouseClient>().LifestyleTransient());
