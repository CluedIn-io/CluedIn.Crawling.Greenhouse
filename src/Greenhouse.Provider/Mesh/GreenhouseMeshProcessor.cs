...
{
    public class Greenhouse_Command_MeshProcessor : BaseMeshProcessor
    {
        public Greenhouse_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          GreenhouseConstants.ProviderId;
